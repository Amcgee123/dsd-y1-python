...
def get_total_data(total_choice):
    ...
    if total_choice == "All":
        extract = df.groupby(['Date','Car Model'], sort=True)['Value']
        total = df['Value'].sum()
        print("The total value of sales for your selection is {}".form)
        ...
        models = ["Ranger", "Model D Premium Plus", "Compass", "Mercury"]
...
if main_menu_choice == "1":
    ...
    while flag:
        ...
        print("")
        print("########### Please select an option #############")
        print("### 1. New and used car sales")   
        print("### 2. Custom selection") 

        choicetwo= input('Enter your number selection here: ')
        ...
        while flag == False:
            if choicetwo == "1":
                newcarsales = (df["new/used"] == "new").sum()
                usedcarsales = (df["new/used"] == "used").sum()

                print("a total of ",newcarsales,"newcars have been sold")
                print("a total of ",usedcarsales,"have been sold ")
                1